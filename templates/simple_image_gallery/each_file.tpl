<td>
 <a class="autoindex_a" href="{file:link}">
  {file:if:is_dir}{if:icon_path}<img loading="lazy" width="16" height="16" src="{file:icon}" alt="{words:thumbnail of} {file:filename}" />{end if:icon_path}{end if} {file:thumbnail}
